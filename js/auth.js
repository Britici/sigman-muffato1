...
import { getDB, saveDB, syncAll } from './api.js?v=20260724b';
import { sv, showToast } from './utils.js?v=20260724b';
import { initRouter, goTo } from './router.js?v=20260724b';
import { buildNav, updateNavDots } from './nav.js?v=20260724b';
