...
import { getDB, saveDB, syncAll } from './api.js?v=20260801c';
import { sv, showToast } from './utils.js?v=20260801c';
import { initRouter, goTo } from './router.js?v=20260801c';
import { buildNav, updateNavDots } from './nav.js?v=20260801c';
