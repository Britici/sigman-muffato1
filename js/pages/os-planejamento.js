...
import { getDB, saveDB, _genPL } from '../api.js?v=20260724b';
import { CU } from '../auth.js?v=20260724b';
import { v, sv, today, showAlert } from '../utils.js?v=20260724b';
import { salasNoEscopo } from '../hierarquia.js?v=20260724b';
