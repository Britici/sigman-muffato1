...
import { getDB, saveDB, _genPL } from '../api.js?v=20260801a';
import { CU } from '../auth.js?v=20260801a';
import { v, sv, today, showAlert } from '../utils.js?v=20260801a';
import { salasNoEscopo } from '../hierarquia.js?v=20260801a';
